                                                ...
                                                <div class="col-lg-5">
                                                    <div class="header__top__right">
                                                        ...
                                                        <div class="header__top__right__social">
                                                            <a href="#"><i class="fa fa-se"><span
                                                                        style="color:green">회원가입</span></i> </a>
                                                        </div>
                                                        <div class="header__top__right__language">
                                                            <<<<<<< HEAD <img src="/resources/img/customer.png" alt="">
                                                                =======
                                                                >>>>>>> develop
                                                                <div>고객센터</div>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-3">
                                            <div class="header__logo">
                                                <a href="/"><img src="/resources/img/logo2.png.png" alt=""
                                                        style="height:70px"></a>
                                            </div>
                                        </div>
                                        <div id="header__menu__fix" class="col-lg-6">
                                            <nav class="header__menu">
                                                ...
                                                <ul>
                                                    <li><a href="#" style="font-size:43; margin-left:15px"><i
